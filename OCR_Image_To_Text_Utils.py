...
def get_string(img_path):
    """
    This function is used for preprocessing and applying OCR via Tesseract
...
def img2text(Imagepath):
    """
    This function will preprocess the image and return the text array.
    :param Imagepath:
    :return: txt
    """
    img_to_txt = get_string("Input.png")
    txt = img_to_txt.split(sep='\n')
    return txt
